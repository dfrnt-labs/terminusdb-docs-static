...
nextjs:
  metadata:
    ...
    keywords: terminusdb, document database, documents, graphs explanation, json-ld
    openGraph:
...
* [System Graph Interface using GraphQL](/docs/system-graph-graphql-interface-reference/)
