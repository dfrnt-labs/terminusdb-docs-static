...
{% http-example method="POST" path="/api/branch/admin/mydb/local/branch/feature" %}
{"origin": "admin/mydb/local/branch/main"}
{% http-expected %}
...
{% http-example method="GET" path="/api/document/admin/mydb/_meta?type=Branch&as_list=true" runnable=false /%}
...
{% http-example method="GET" path="/api/log/admin/mydb/local/branch/main?count=5" runnable=false /%}
...
{% http-example method="POST" path="/api/apply/admin/mydb/local/branch/main" %}
